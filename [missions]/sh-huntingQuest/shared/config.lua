...
Config.WeaponHash = -1466123874

Config.JobVeh = 'rebel'
Config.SpawnJobVehicle = vector4(-684.8661, 5825.1323, 17.3307, 105.2597)

Config.PedModel = 'ig_hunter'
Config.Animals ={
    ['deer'] = {
        model = 'a_c_deer',
...
Config.MissionPlace = { -- Podstawowe miejsca oraz punkty od huntingu
    ['npc'] = { 
        coords = vector4(-682.7876, 5834.7354, 17.3313, 106.0479),
    ...
    ['sttrail'] = {
        ...
        waterText = Config.Translations[Config.Lang].waterText,
    ...
    ['ndtrail'] = {
        ...
        poopText = Config.Translations[Config.Lang].poopText,
    },
    ['rdtrail'] = {
        group ={
        ...
        trailText = Config.Translations[Config.Lang].trailText,
    },
    ['appear'] = {
        group ={
